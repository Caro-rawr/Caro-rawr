...
**[climate-risk-transition-monitor](https://github.com/Caro-rawr/climate-risk-transition-monitor)**  
Python toolkit for climate transition risk analysis under NGFS Phase V scenarios (Net Zero 2050 through Current Policies). Computes a Transition Risk Exposure Index (TREI) integrating carbon price exposure, technology gap, and stranded asset probability — across sectors and portfolios. Includes sector crosswalks for GICS, NACE, and BMV classifications, a Streamlit dashboard, and exportable IFRS S2-structured Excel reports. Built for Latin American portfolio context.  
`Python` `NGFS` `IFRS-S2` `TCFD` `transition-risk` `ESG`
...
| Climate frameworks | GHG Protocol · TCFD · IFRS S2 · ISO 14064 · IPCC Guidelines 2019 |
...
- **Climate risk & finance** — transition risk exposure, NGFS scenario analysis,
  IFRS S2 / TCFD disclosure, portfolio-level climate stress testing
